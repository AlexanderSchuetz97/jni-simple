...
pub mod test {
    ...
    unsafe fn get_test_class() -> jclass {
        let env = get_env();
        let class_loaded = env.FindClass_str("FieldTests");
        ...
        let class_loaded = env.DefineClass_str("FieldTests", null_mut(), class_blob);
        if class_loaded.is_null() {
    ...
    unsafe fn get_test_obj() -> jobject {
        ...
        let local_obj = env.GetStaticFieldID_str(tc, "staticInstance", "LFieldTests;");
    ...
    //    let env = get_env();
    //    let class = get_test_class();
    //    let reset = env.GetStaticMethodID_str(class, "dump", "()V");
    //    env.CallStaticVoidMethod0(class, reset);
    //    env.DeleteGlobalRef(class);
    //}
    ...
    unsafe fn add_it() {
        let env = get_env();
        let class = get_test_class();
        let reset = env.GetStaticMethodID_str(class, "add", "()V");
        env.CallStaticVoidMethod0(class, reset);
        env.DeleteGlobalRef(class);
    }
    ...
    fn test_bool() {
        ...
        unsafe {
            ...
            let field = env.GetStaticFieldID_str(test_class, "staticBool", "Z");
            ...
            let field = env.GetFieldID_str(test_class, "dynBool", "Z");
    ...
    fn test_byte() {
        ...
        unsafe {
            ...
            let env = get_env();
            let test_class = get_test_class();
            let field = env.GetStaticFieldID_str(test_class, "staticByte", "B");
            ...
            let test_obj = get_test_obj();
            let field = env.GetFieldID_str(test_class, "dynByte", "B");
    ...
    fn test_short() {
        ...
        unsafe {
            ...
            let env = get_env();
            let test_class = get_test_class();
            let field = env.GetStaticFieldID_str(test_class, "staticShort", "S");
            ...
            let test_obj = get_test_obj();
            let field = env.GetFieldID_str(test_class, "dynShort", "S");
    ...
    fn test_int() {
        ...
        unsafe {
            ...
            let env = get_env();
            let test_class = get_test_class();
            let field = env.GetStaticFieldID_str(test_class, "staticInt", "I");
            ...
            let test_obj = get_test_obj();
            let field = env.GetFieldID_str(test_class, "dynInt", "I");
    ...
    fn test_long() {
        ...
        unsafe {
            ...
            let env = get_env();
            let test_class = get_test_class();
            let field = env.GetStaticFieldID_str(test_class, "staticLong", "J");
            ...
            let test_obj = get_test_obj();
            let field = env.GetFieldID_str(test_class, "dynLong", "J");
    ...
    fn test_float() {
        ...
        unsafe {
            ...
            let env = get_env();
            let test_class = get_test_class();
            let field = env.GetStaticFieldID_str(test_class, "staticFloat", "F");
            ...
            let test_obj = get_test_obj();
            let field = env.GetFieldID_str(test_class, "dynFloat", "F");
    ...
    fn test_double() {
        ...
        unsafe {
            ...
            let env = get_env();
            let test_class = get_test_class();
            let field = env.GetStaticFieldID_str(test_class, "staticDouble", "D");
            ...
            let test_obj = get_test_obj();
            let field = env.GetFieldID_str(test_class, "dynDouble", "D");
    ...
    fn test_obj() {
        ...
        unsafe {
            ...
            let env = get_env();
            let test_class = get_test_class();
            let field = env.GetStaticFieldID_str(test_class, "staticObject", "Ljava/lang/Object;");
            ...
            let test_obj = get_test_obj();
            let field = env.GetFieldID_str(test_class, "dynObject", "Ljava/lang/Object;");
